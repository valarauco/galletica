...
class OC_USER_LDAP extends OC_User_Backend {
	...
	public function getUsers(){
		if(is_null($this->_users)) {
			...
			//Valarauco
			//TODO: Reload if lastupdate > time + TTL?? 
			//TODO: Link para que un crontab actualice los usuarios de LDAP de manera forzada
			$this->_users = OC_LDAP::ocnameUserList();
		}
		error_log('[LDAP-U] getUsers: $_users '.implode(' ',$this->_users));
		return $this->_users;
	}
