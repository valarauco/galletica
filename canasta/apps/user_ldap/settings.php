...
$tmpl->assign( 'ldap_ttl', OCP\Config::getAppValue('user_ldap', 'ldap_ttl', '1440'));
$tmpl->assign( 'ldap_lastupdate', date('Y-M-d h:i', OCP\Config::getAppValue('user_ldap', 'ldap_lastupdate', '')));
