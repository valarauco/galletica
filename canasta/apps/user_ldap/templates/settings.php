<form id="ldap" action="#" method="post">
	...
	<fieldset id="ldapSettings-1">
		...
		<!-- valarauco -->
		<p><label for="ldap_lastupdate"><?php echo $l->t('Last Update').' <strong>'. $_['ldap_lastupdate']. '</strong>';?></label><p>
		<p><label for="ldap_ttl"><?php echo $l->t('Time to live');?></label><input type="text" id="ldap_ttl" name="ldap_ttl" value="<?php echo $_['ldap_ttl']; ?>" /> minutes</p>
	</fieldset>
	<fieldset id="ldapSettings-2">
		...
		<!-- valarauco EDIT -->
		<p><label for="ldap_quota_attr"><?php echo $l->t('Quota Attribute');?></label><input type="text" id="ldap_quota_attr" name="ldap_quota_attr" value="<?php echo $_['ldap_quota_attr']; ?>" />
		<label for="ldap_quota_def"><?php echo $l->t('Quota Default');?></label><input type="text" id="ldap_quota_def" name="ldap_quota_def" value="<?php if (isset($_['ldap_quota_def'])) echo $_['ldap_quota_def']; ?>" />bytes</p>
		<p><label for="ldap_email_attr"><?php echo $l->t('Email Attribute');?></label><input type="text" id="ldap_email_attr" name="ldap_email_attr" value="<?php echo $_['ldap_email_attr']; ?>" /></p>
	</fieldset>
